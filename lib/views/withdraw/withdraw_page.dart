...
import 'package:tipy_shop/views/withdraw/request_withdraw_update_page.dart';
                              ...
                              children: [
                                  ...
                                  children: [
                                    Text(
                                      Get.find<GlobalController>().currency! +
                                          creditData.totalBalance.toString(),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      Get.find<GlobalController>().currency! +
                                          creditData.orderBalance.toString(),
                                      style: const TextStyle(
                                        fontWeight: FontWeight.w600,
                                        fontSize: 24,
                                        color: AppColor.primaryFont,
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      Get.find<GlobalController>().currency! +
                                          creditData.withdrawAmount.toString(),
                                      style: const TextStyle(
                                        fontWeight: FontWeight.w600,
                                        fontSize: 24,
                                        color: AppColor.primaryFont,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      Get.find<GlobalController>().currency! +
                                          creditData.requestedAmount.toString(),
                                      style: const TextStyle(
                                        fontWeight: FontWeight.w600,
                                        fontSize: 24,
                                        color: AppColor.primaryFont,
